...
.search-wrapper form{display:flex;}
.search-wrapper input{
    flex:1;border:1.6px solid #000;border-radius:8px;padding:.7rem 1rem;font-size:1rem;outline:none;
}
...
@media(max-width:768px){
    ...
    .section-header h1{justify-self:start;}
